...
public class ComplexParticleSystem {
	...
	public ComplexParticleSystem(ParticleTexture texture, float pps, float speed, float gravityComplient,
	...
	public void generateParticles(Vector3f systemCenter, boolean alpha) {
		if (Particle.particles) {
			...
			for (int i = 0; i < count; i++) {
				emitParticle(systemCenter, alpha);
			}
	...
	private void emitParticle(Vector3f center, boolean alpha) {
