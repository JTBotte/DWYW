...
public class Loader {
	...
	public int loadGameTexture(String fileName) {
		...
		try {
			...
			try {
				texture = TextureLoader.getTexture("PNG", Class.class.getResourceAsStream("/res/default.png"));
			} catch (FileNotFoundException e1) {
				System.out.println("MISSING DEFAULT TEXTURE!");
				e1.printStackTrace();
				System.exit(-1);
			...
			System.out.println(fileName + "was not given a texture!");
			e.printStackTrace();
